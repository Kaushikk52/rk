...
const Section: React.FC<SectionProps> = ({ id, title, icon: Icon, isActive }) => {
  const content: { [key: string]: string } = {
    'overview': "This website is operated by RK Insurance. Throughout the site, the terms 'we', 'us' and 'our' refer to RK Insurance. RK Insurance offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.",
    ...
    'indemnification': "You agree to indemnify, defend and hold harmless RK Insurance and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.",
