...
const AdvantageCards = () => {
    const advantages = [
        { id: 1, delay: 100, image: Bestprice, title: 'Best Prices', text: 'Guaranteed', },
        { id: 2, delay: 300, image: Chat, title: 'Unbiased Advice', text: 'Keeping customers first', },
        { id: 3, delay: 500, image: Insignia, title: '100% Relaible', text: 'Regulated by IRDAI', },
        { id: 4, delay: 700, image: Suport, title: 'Claim Support', text: 'Made stress-free', },
        { id: 5, delay: 900, image: Student, title: 'Happy to help', text: 'Every day of the week', },
    ]
    return (
        <>
            <div className='max-w-7xl container mx-auto px-4'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 my-10'>
                    {advantages.map((advantage) => (
                        <Slide key={advantage.id} triggerOnce direction='left' delay={advantage.delay}>
                            <Fade triggerOnce>
