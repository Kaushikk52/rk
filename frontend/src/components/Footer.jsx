            ...
            <div className='w-full px-6 bg-[#15233c] text-white poppins-regular'>
                <div className='max-w-7xl container mx-auto px-6'>
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 py-14'>
                        ...
                        {/* Address Section */}
                        <div>
                            <h1 className='font-semibold text-xl py-4 text-left  sm:text-left'>Address</h1>
                            <div className='flex flex-col space-y-4 text-[#a7a8b4]'>
                                <div className='flex items-start space-x-4'>
                                    <FaLocationDot className='h-6 w-6' />
                                    <p className='text-sm sm:text-base'>
                                        A - 417, 1st Floor, TTC Industrial Estate, MIDC, Mahape, Navi Mumbai - 400710
                                    </p>
                                </div>
                        ...
                        {/* Quick Links Section */}
                        <div>
                            <h1 className='font-semibold text-xl py-4 text-left  sm:text-left'>Quick Links</h1>
                        ...
                        <div className='flex flex-col justify-start'>
                            <h1 className='font-semibold text-xl py-4 text-left  sm:text-left'>Map</h1>
                            <iframe
